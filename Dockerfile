...
RUN apt-get update && apt-get -y install xvfb x11vnc xdotool wget tar supervisor winehq-devel net-tools fluxbox cabextract
...
RUN chmod +x /root/blueiris.sh /root/launch_blueiris.sh /root/check_process.sh
